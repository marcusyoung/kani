...
- [x] `src/kani/router.py:176` and `src/kani/router.py:183` now call `_eligible_primary_candidates(..., prompt_tokens=prompt_tokens)` / `_eligible_fallback_candidates(..., prompt_tokens=prompt_tokens)`, matching the helper signatures at `src/kani/router.py:446-452` and `src/kani/router.py:466-472`. Focused acceptance verification command `agent-exec run -- uv run pytest tests/test_router_logging.py tests/test_capability_routing.py tests/test_fallback_backoff.py tests/test_context_window_routing.py -q` passed.
