...
- [x] Re-run archive-gate after verification-note and test hardening. Completion condition: `cflx openspec validate harden-reasoning-content-compat --archive-gate` succeeds after the tasks and test changes are present. (verification: integration - `cflx openspec validate harden-reasoning-content-compat --archive-gate`)
